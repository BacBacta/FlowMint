/**
 * DCA Intent Creation API Route (Proxy)
 *
 * Proxies DCA intent creation to backend /api/v1/intents/dca
 */
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const resp = await fetch(`${backend}/api/v1/intents/dca`, {
      method: 'POST',
    ...
    console.error('DCA intent proxy error:', error);
    return NextResponse.json(
