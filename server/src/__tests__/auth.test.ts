...
describe('Authentication Middleware', () => {
  ...
  describe('requireAuth middleware', () => {
    it('should pass with valid token', async () => {
      const { requireAuth, generateToken, AuthenticatedRequest } = await import('../middleware/auth.js');
  ...
  describe('optionalAuth middleware', () => {
    it('should attach user if valid token provided', async () => {
      const { optionalAuth, generateToken, AuthenticatedRequest } = await import('../middleware/auth.js');
  ...
  describe('requireOwnership middleware', () => {
    it('should allow access when user matches resource owner', async () => {
      const { requireOwnership, generateToken, AuthenticatedRequest } = await import('../middleware/auth.js');
